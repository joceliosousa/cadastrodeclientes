					...
					"config": {
						"inbounds": {
							"CadastrodeClientes-display": {
								...
								"action": "display",
								"description": "Cadastro de Clientes - meufiori",
								"title": "Cadastro de Clientes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=meufiori.cadastrodeclientes",
									"url": sap.ui.require.toUrl("meufiori/cadastrodeclientes")
								}
							}
						}
					}
