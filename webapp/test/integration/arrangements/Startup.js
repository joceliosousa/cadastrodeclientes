sap.ui.define([
	"sap/ui/test/Opa5",
	"meufiori/cadastrodeclientes/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("meufiori.cadastrodeclientes.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "meufiori.cadastrodeclientes",
					async: true
				},
				hash: oOptions.hash,
