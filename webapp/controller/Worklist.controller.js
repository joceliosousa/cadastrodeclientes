sap.ui.define([
	...
	return BaseController.extend("meufiori.cadastrodeclientes.controller.Worklist", {
		...
		onClienteDelete2:function(oEvent){
		...
		onAlterarStatus:function(oEvent){
			...
			oModel.callFunction(
				"/AlterarStatus",{
					...
					success: function(){
						sap.m.MessageToast.show('Cliente alterado com sucesso.');
					}.bind(this),
					error: function(e){
						console.error(e);
					}.bind(this)
