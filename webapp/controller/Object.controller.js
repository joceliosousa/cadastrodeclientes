sap.ui.define([
	...
	return BaseController.extend("meufiori.cadastrodeclientes.controller.Object", {
		...
		onGravar:function(){
			...
			//var path = "/ClienteSet('0000000002')";
		...
		onGravar2:function(){
			...
			if(oModel.hasPendingChanges()  ){
				...
				MessageToast.show("Sem dados pra gravar");
				return;
		...
		onValueHelpRequest: function (oEvent) {
			...
			this._UFDialog = Fragment.load({
				id: oView.getId(),
				name: "meufiori.cadastrodeclientes.view.UFDialog",
				controller: this
